                     ...
                     <!--TAB MENU LINKS-->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <ul class="process-label">
                                ...
                                <li class="process-label2 active" id="label-2">Questions & Schedule<span><i class="fa fa-long-arrow-right"></i></span></li>
                            ...
                            <div class="row">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <h2 style="color: #565656;">Schedule</h2>If you are flexible on the hours for that day write `Flexible`. If you have specific hours write those in. For e.g. 8am-5pm. If you'd like certain days off, write OFF.  
