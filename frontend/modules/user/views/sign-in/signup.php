    ...
    <div class="row">
        <div class="col-lg-5">
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                <p>
                 <a href="https://nannycare.nyc3.digitaloceanspaces.com/assets/NCTerms2018Revised.pdf" target=_blank>Click here to read the Terms and Conditions and Privacy Policy</a>
                </p>
